...
public class VolleyApplication extends Application {
    ...
    //GrowthHackで追加ここから
    //トラッキングIDを設定
    private static final String PROPERTY_ID = "UA-93014666-1";
    ...
    // getTracker GAにデータを送る
    public synchronized Tracker getTracker(TrackerName trackerId) {
        if (!mTrackers.containsKey(trackerId)) {

            GoogleAnalytics analytics = GoogleAnalytics.getInstance(this);
            //基本的にAPP_TRACKERのみ使っていて、GLOBAL_TRACKERは使っていない
            //下は二項分布で記載している
    ...
    public void onCreate() {
        ...
        Kii.initialize(getApplicationContext(), "e485dee1", "44249f4b7858db27f7054e2b4f040479", Kii.Site.JP,true);//GrowthHack(ABテスト)修正。
        //Userで追加ここまで
    }
